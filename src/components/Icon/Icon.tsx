...
function Icon({
  ...
  if (source === 'placeholder') {
    ...
    // eslint-disable-next-line no-console
    console.warn(
      `Deprecation: passing the string "${source}" is deprecated and will be removed in the next major version. Pass in the "${componentImportName}" React Component from the @shopify/polaris-icons package instead.`,
    );
